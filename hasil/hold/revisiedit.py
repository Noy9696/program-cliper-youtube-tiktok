...
VIDEO_FOLDER = r"D:\CLIP\hasil\hold"  # Folder isi potongan video
TRANSITION_VIDEO = r"D:\CLIP\hasil\hold\TV.mp4"  # Video transisi 1 detik
OUTPUT_FILE = r"D:\CLIP\hasil\final_output.mp4"
...
SCENE_DONE_COLOR = "#888888"        # Scene yang udah lewat (abu-abu medium)
SCENE_UPCOMING_COLOR = "#AAAAAA"    # Scene yang belum (abu-abu terang, lebih keliatan)
...
# ========================================
print("="*60)
print("🎬 VIDEO MERGER - PROGRESSIVE SCENE LIST (FIXED)")
print("="*60)
...
# ========================================
print("\n🎨 Step 1: Menambahkan progressive list ke semua scene...")
print("="*60)
...
if result.returncode == 0:
    ...
    print(f"\n🎨 Kalau mau adjust posisi, edit:")
    print(f"   - TEXT_Y_START (naik/turun judul)")
    print(f"   - HEADER_TO_SCENE_GAP (jarak judul ke list)")
    print(f"   - SCENE_LINE_SPACING (jarak antar scene)")
else:
    print(f"\n❌ GAGAL!")
    print(f"\n📋 Error:")
